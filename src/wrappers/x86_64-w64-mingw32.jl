# Autogenerated wrapper script for htslib_jll for x86_64-w64-mingw32
export htsfile, bgzip, tabix, libhts
...
const htsfile_splitpath = ["bin", "htsfile.exe"]
...
const bgzip_splitpath = ["bin", "bgzip.exe"]
...
const tabix_splitpath = ["bin", "tabix.exe"]
...
const libhts_splitpath = ["bin", "hts-3.dll"]
