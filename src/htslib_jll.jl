...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import htslib_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f06fe41e-9474-5571-8c61-5634d2b2700c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "htslib", artifacts_toml) for e in artifacts["htslib"]]
...
if best_platform === nothing
    @debug("Unable to load htslib; unsupported platform $(triplet(platform_key_abi()))")
else
